...
2. A Spacer-ek átalakítása lapos korongokká: minden Spacer-hez `⌈gap_mm / spacer_material vastagsága⌉` db kör alakú alkatrész, `spacer_diameter_mm` átmérővel. Ha a Spacer Dowel-re fűzött (GAP_SYSTEM_SPEC.md 6. szakasz 4/a. pont), minden így keletkező korong középpontos furatot is kap, a rajta átmenő Dowel átmérőjével megegyező mérettel — az önálló (nem Dowel-re fűzött) Spacer-ek korongjai furat nélküli, tömör korongok maradnak.
