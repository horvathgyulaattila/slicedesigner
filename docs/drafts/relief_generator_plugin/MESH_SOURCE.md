...
Státusz: Tervezet Tulajdonos: Horváth Gyula Attila Létrehozva:
2026-08-07 Utolsó módosítás: 2026-08-07 Kapcsolódó dokumentumok:
...
Ez a dokumentum a `MeshSource` architekturális szerződés első tervezete.
Elfogadásáig az itt szereplő döntések a későbbi dokumentáció és
implementáció alapjául nem tekintendők véglegesnek.
